...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    skills: {
      ...
      systemSpaceTab: "系统 Skills",
      communitySpaceTab: "社区 Skills",
      personalSpaceTab: "我的 Skills",
      communitySearchPlaceholder: "按名称或作者搜索社区 Skill",
      allSegment: "全部",
      systemSegment: "系统",
      installedSegment: "已安装",
      authoredSegment: "我创建的",
      ...
      notInstalled: "未安装",
      updateAvailable: "有更新",
      availableInCommunity: "可安装",
      installedToPersonal: "已安装",
      published: "已发布",
      unpublished: "未发布",
      ...
      noSkillHubSkillsDescription: "社区发布的 Skill 会展示在这里。",
