...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    skillSourceOfficial: "官方",
    skillSourceUnknown: "未知来源",
    skillVersionUnavailable: "版本不可用",
    skillUpdateAvailable: "有可用更新",
    skillMetadataUnavailable: "技能不可用",
    enabledSkillsLabel: "个技能已启用",
    noBoundSkills: "未绑定技能",
    createButton: "创建智能体",
  ...
  settings: {
    ...
    skills: {
      ...
      notInstalled: "未安装",
      updateAvailable: "有更新",
      availableInCommunity: "可添加到我的空间",
      downloadedToPersonal: "已添加到我的空间",
      published: "已发布",
      unpublished: "未发布",
      unpublishedChanges: "有未发布改动",
      mySkill: "我的 Skill",
      publishedByYou: "我发布的 Skill",
      forkedSkill: "Fork Skill",
      ...
      downloadedSource: (ownerDisplayName: string) =>
        `来自社区空间：${ownerDisplayName}`,
      forkedSource: (ownerDisplayName: string) => `基于 ${ownerDisplayName}`,
      installedSource: "已添加到我的空间",
      createdSource: "我的空间中的 Skill",
      addToPersonalSpace: "添加到我的空间",
      viewInPersonalSpace: "在我的空间查看",
