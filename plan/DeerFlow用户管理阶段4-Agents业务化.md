...
- thread / workspace 闭环已建立
- 阶段 3 已能稳定创建用户级 thread
...
- 历史 thread 会随 agent 当前配置变化而变化，这是当前方案已接受的 tradeoff
